...
public class PixieData {
    ...
    public static final PixieData DEFAULT = new PixieData(EntityPixie.PixieVariant.SWALLOWTAIL, 1, PixieData.MAX_MOOD / 2);
    ...
    PixieData(EntityPixie.PixieVariant variant, float size, float mood) {
        maxHealth = 10;
        health = maxHealth;
    ...
    public static PixieData newPixie(Random rand) {
        return newPixie(EntityPixie.PixieVariant.random(rand), rand);
    }

    public static PixieData newPixie(EntityPixie.PixieVariant variant, Random rand) {
    ...
    public static class Serializer implements DataSerializer<PixieData> {
        ...
        public PixieData read(PacketBuffer buf) throws IOException {
            return new PixieData(EntityPixie.PixieVariant.get(buf.readByte()), buf.readFloat(), buf.readFloat());
        }
