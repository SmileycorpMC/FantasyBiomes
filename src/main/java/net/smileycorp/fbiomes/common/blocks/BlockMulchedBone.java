...
public class BlockMulchedBone extends BlockBase {
    ...
    public BlockMulchedBone() {
        super("mulched_bone", Constants.MODID, Material.CLAY, SoundType.GROUND, 1f, 1,  "shovel", 0, FantasyBiomes.TAB);
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess blockAccess, BlockPos pos, IBlockState state, int fortune) {
        ...
        LootTable table = world.getLootTableManager().getLootTableFromLocation(FBiomesLootTables.MULCHED_BONE);
