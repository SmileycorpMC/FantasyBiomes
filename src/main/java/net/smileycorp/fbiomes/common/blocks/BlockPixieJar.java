...
public class BlockPixieJar extends BlockBase implements ITileEntityProvider {
    ...
    public BlockPixieJar() {
        super("pixie_jar", Constants.MODID, Material.GLASS, SoundType.GLASS, 0.3f, 1.5f, 0, FantasyBiomes.TAB);
    }
    ...
    public static ItemStack jarPixie(PixieData pixie) {
        ItemStack stack = new ItemStack(FBiomesBlocks.PIXIE_JAR, 1, pixie.getVariant().ordinal());
