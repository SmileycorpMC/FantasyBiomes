package net.smileycorp.phantasiai.common.potion;
...
public class PotionPhantasiai extends Potion {
    
    private final ResourceLocation texture;
    
    public PotionPhantasiai(boolean isBad, int colour, String name) {
        super(isBad, colour);
        setPotionName("effect.phantasiai." + name);
