...
public class WorldGenBigGlowshroom extends WorldGenerator {
	...
	public WorldGenBigGlowshroom(EnumGlowshroomVariant type) {
		super();
		stem = PhantasiaiBlocks.BIG_GLOWSHROOM.getDefaultState().withProperty(BlockBigGlowshroom.SHAPE, EnumMushroomShape.STEM).withProperty(BlockBigGlowshroom.VARIANT, type);
		cap = PhantasiaiBlocks.BIG_GLOWSHROOM.getDefaultState().withProperty(BlockBigGlowshroom.SHAPE, EnumMushroomShape.CAP).withProperty(BlockBigGlowshroom.VARIANT, type);
	}
