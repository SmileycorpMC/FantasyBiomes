...
public class WorldGenSmallToadstool extends WorldGenerator {
	...
	protected static final IBlockState STEM = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.VARIANT, EnumMushroomVariant.TOADSTOOL)
			.withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.STEM);
	protected static final IBlockState CAP = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.VARIANT, EnumMushroomVariant.TOADSTOOL)
			.withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.CAP);
	protected static final IBlockState SPOT = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.VARIANT, EnumMushroomVariant.TOADSTOOL)
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		if (!natural &! soil.getBlock().canSustainPlant(soil, world, pos, EnumFacing.UP, PhantasiaiBlocks.TOADSTOOL)) return false;
