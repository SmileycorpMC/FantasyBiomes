...
public class WorldGenLog extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        IBlockState state = rand.nextInt(3) ==  0 ? PhantasiaiBlocks.WOOD.getLogState(EnumWoodType.ORANTIKKU,
    ...
    protected void setBlockAndNotifyAdequately(World world, BlockPos pos, IBlockState state) {
        ...
        if (block != Blocks.LOG || block != PhantasiaiBlocks.WOOD.getLogState(EnumWoodType.ORANTIKKU, BlockLog.EnumAxis.Y).getBlock()) return;
