...
public class WorldGenOrantikkuTree extends WorldGenAbstractTree implements IMultiFacePlacer {
	...
	protected static final IBlockState LOG = PhantasiaiBlocks.WOOD.getLogState(EnumWoodType.ORANTIKKU, BlockLog.EnumAxis.Y);
	protected static final IBlockState BARK = PhantasiaiBlocks.WOOD.getLogState(EnumWoodType.ORANTIKKU, BlockLog.EnumAxis.NONE);
	protected static final IBlockState LEAVES = PhantasiaiBlocks.WOOD.getLeavesState(EnumWoodType.ORANTIKKU)
	...
	private void setBlock(World world, Random rand, BlockPos pos, IBlockState state) {
		...
		if (rand.nextInt(5) == 1) {
			...
			IBlockState shroom = (rand.nextInt(3) < 2 ? PhantasiaiBlocks.glowshrooms[rand.nextInt(PhantasiaiBlocks.glowshrooms.length)]:
	...
	public boolean supportsMultiFace(IBlockState state) {
		return state.getBlock() == PhantasiaiBlocks.WOOD.getLogState(EnumWoodType.ORANTIKKU, BlockLog.EnumAxis.NONE).getBlock();
	}
