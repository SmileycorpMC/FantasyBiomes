...
import net.smileycorp.phantasiai.common.blocks.BlockBigMushroom;
...
import net.smileycorp.phantasiai.common.blocks.enums.EnumMushroomVariant;
...
public class WorldGenHugeFBMushroom extends WorldGenHugeMushroomBase {
	...
	public WorldGenHugeFBMushroom(EnumMushroomVariant type) {
		super(PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.STEM).withProperty(BlockBigMushroom.VARIANT, type),
				PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.CAP).withProperty(BlockBigMushroom.VARIANT, type));
		spot = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.SPOT).withProperty(BlockBigMushroom.VARIANT, type);
	}
	
	@Override
	protected void pickType(Random rand) {
		EnumMushroomVariant variant = EnumMushroomVariant.values()[rand.nextInt(1) + 1];
		stem = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.STEM).withProperty(BlockBigMushroom.VARIANT, variant);
		cap = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.CAP).withProperty(BlockBigMushroom.VARIANT, variant);
		spot = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.SPOT).withProperty(BlockBigMushroom.VARIANT, variant);
	}
