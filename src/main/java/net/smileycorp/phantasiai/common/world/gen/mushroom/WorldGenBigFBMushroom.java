...
public class WorldGenBigFBMushroom extends WorldGenerator {
	...
	public WorldGenBigFBMushroom(EnumMushroomVariant type) {
		super();
		stem = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.STEM).withProperty(BlockBigMushroom.VARIANT, type);
		cap = PhantasiaiBlocks.BIG_SHROOM.getDefaultState().withProperty(BlockBigMushroom.SHAPE, EnumMushroomShape.CAP).withProperty(BlockBigMushroom.VARIANT, type);
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		if (!natural &! soil.getBlock().canSustainPlant(soil, world, pos.down(), EnumFacing.UP, PhantasiaiBlocks.TOADSTOOL)) return false;
