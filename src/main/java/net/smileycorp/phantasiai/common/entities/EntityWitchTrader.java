...
public class EntityWitchTrader extends EntityAgeable implements IMerchant, INpc {
    ...
    private void populateBuyingList() {
        ...
        offers.add(new MerchantRecipe(new ItemStack(PhantasiaiBlocks.TOADSTOOL, 16), new ItemStack(PhantasiaiItems.PIXIE_HOUSING, 1, 1)));
        offers.add(new MerchantRecipe(new ItemStack(PhantasiaiBlocks.PURPLE_SHROOM, 20), new ItemStack(PhantasiaiBlocks.GREEN_SHROOM, 20),
                new ItemStack(PhantasiaiItems.PIXIE_HOUSING, 1, 2)));
    }
