...
public class BlockTwistedGnarlwillow extends BlockBase {
    ...
    public BlockTwistedGnarlwillow() {
        super("twisted_gnarlwillow", Constants.MODID, Material.WOOD, SoundType.WOOD, 2f, 5f, "axe", 0, Phantasiai.TAB);
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        drops.add(PhantasiaiBlocks.WOOD.getLogStack(EnumWoodType.GNARLWILLOW, 1));
    }
