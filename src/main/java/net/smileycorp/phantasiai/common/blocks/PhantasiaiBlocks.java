...
public class PhantasiaiBlocks {
	...
	//Trees
	public static WoodBlock WOOD = new WoodBlock<>(Constants.MODID, Phantasiai.TAB, EnumWoodType.class, true);
	public static BlockBaseSapling VANILLA_SAPLING = BlockBaseSapling.create("simple_sapling", Constants.MODID, Phantasiai.TAB, EnumVanillaWoodType.class, 0);
	public static BlockBaseLeaves VANILLA_LEAVES = BlockBaseLeaves.create("simple_leaves", Constants.MODID, Phantasiai.TAB, null, EnumVanillaWoodType.class, 0);
	...
	public static void registerBlocks(RegistryEvent.Register<Block> event) {
		...
		for (Field field : PhantasiaiBlocks.class.getDeclaredFields()) {
			try {
