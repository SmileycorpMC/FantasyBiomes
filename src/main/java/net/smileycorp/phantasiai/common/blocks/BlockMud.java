...
public class BlockMud extends BlockBase implements GrowsGrass {
	...
	public BlockMud() {
		super("mud", Constants.MODID, Material.CLAY, SoundType.GROUND, 0.5f, 1,  "shovel", 0, Phantasiai.TAB);
    ...
    public IBlockState getGrass(IBlockState state, Random random) {
        return PhantasiaiBlocks.GRASSY_MUD.getDefaultState().withProperty(VARIANT, state.getValue(VARIANT));
    }
